...
class LoadingDotWidget extends StatefulWidget {
  ...
  @override
  _LoadingDotWidgetState createState() => _LoadingDotWidgetState();
}

class _LoadingDotWidgetState extends State<LoadingDotWidget> with SingleTickerProviderStateMixin {
